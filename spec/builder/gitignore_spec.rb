...
RSpec.describe PathList::Builder::Gitignore do
      ...
      describe 'from the gitignore documentation' do
        ...
        describe 'If the pattern ends with a slash, it is removed for the purpose of the following description' do
          describe 'but it would only find a match with a directory' do
            ...
            it 'ignores directories but not files or symbolic links that match patterns ending with /' do
              expect(build('foo/'))
                .to be_like PathList::Matchers::MatchIfDir.new(
                  PathList::Matchers::PathRegexp.new(%r{/foo\z}, :allow)
                )
            end
            ...
            it 'handles this specific edge case i stumbled across' do
              expect(build('Ȋ/'))
                .to be_like PathList::Matchers::MatchIfDir.new(
                  PathList::Matchers::PathRegexp.new(%r{/ȋ\z}, :allow)
                )
            end
          end
        end
        ...
        describe 'If there is a separator at the beginning or middle (or both) of the pattern' do
          describe 'then the pattern is relative to the directory level of the particular .gitignore file itself.' do
            ...
            it 'includes files relative to the git dir with a middle slash' do
              expect(build('doc/frotz'))
                .to be_like PathList::Matchers::ExactString.new('/doc/frotz', :allow)
            end
          ...
          describe 'Otherwise the pattern may also match at any level below the .gitignore level.' do
            ...
            it 'includes files relative to anywhere with only an end slash' do
              expect(build('frotz/'))
                .to be_like PathList::Matchers::MatchIfDir.new(
                  PathList::Matchers::PathRegexp.new(%r{/frotz\z}, :allow)
                )
            end
        ...
        describe 'An optional prefix "!" which negates the pattern' do
          ...
          describe 'Put a backslash ("\") in front of the first "!" for patterns that begin with a literal "!"' do
            ...
            it 'matches files starting with a literal ! if its preceded by a backslash' do
              expect(build('\!important!.txt'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/!important!\.txt\z}, :allow)
            end
          end
        end
        ...
        describe 'Otherwise, Git treats the pattern as a shell glob' do
          describe '"*" matches anything except "/"' do
            describe 'single level' do
              ...
              it "doesn't match a slash" do
                expect(build('f*our'))
                  .to be_like PathList::Matchers::PathRegexp.new(%r{/f[^/]*our\z}, :allow)
              end

              it "matches any number of characters in the middle if there's a star" do
                expect(build('f*r'))
                  .to be_like PathList::Matchers::PathRegexp.new(%r{/f[^/]*r\z}, :allow)
              end

              it "matches any number of characters at the end if there's a star" do
                expect(build('few*'))
                  .to be_like PathList::Matchers::PathRegexp.new(%r{/few[^/]*\z}, :allow)
              end
            end
            ...
            describe 'multi level' do
              ...
              it 'matches an exact partial match at start' do
                expect(build('a/b*/c'))
                  .to be_like PathList::Matchers::PathRegexp.new(%r{\A/a/b[^/]*/c\z}, :allow)
              end
              ...
              it 'matches multiple directories when ending with /**/*' do
                expect(build('a/**/*'))
                  .to be_like PathList::Matchers::PathRegexp.new(%r{\A/a/}, :allow)
              end
          ...
          describe '"?" matches any one character except "/"' do
            it "matches one character at the beginning if there's a ?" do
              expect(build('?our'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/[^/]our\z}, :allow)
            end

            it "doesn't match a slash" do
              expect(build('fa?our'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/fa[^/]our\z}, :allow)
            end
            ...
            it "matches a single character at the end if there's a ?" do
              expect(build('fou?'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/fou[^/]\z}, :allow)
            end
          end
          ...
          describe '"[]" matches one character in a selected range' do
            it 'matches a single character in a character class' do
              expect(build('a[ab]'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/a(?!/)[ab]\z}, :allow)
            end
            ...
            it 'treats a backward character class range as only the first character of the range' do
              expect(build('a[d-a]'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/a(?!/)[d]\z}, :allow)
            end
            ...
            it 'treats a escaped backward character class range as only the first character of the range' do
              expect(build('a[\\]-\\[]'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/a(?!/)[\]]\z}, :allow)
            end
            ...
            it 'treats a backward character class range with other options as only the first character of the range' do
              expect(build('a[d-ba]'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/a(?!/)[da]\z}, :allow)
            end
            ...
            it 'treats a backward char class range with other initial options as the first char of the range' do
              expect(build('a[ad-b]'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/a(?!/)[ad]\z}, :allow)
            end
            ...
            it "doesn't match a slash even if you specify it last" do
              expect(build('b[i/]b'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/b(?!/)[i/]b\z}, :allow)
            end

            it "doesn't match a slash even if you specify it alone" do
              expect(build('b[/]b'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/b(?!/)[/]b\z}, :allow)
            end
            ...
            it "doesn't match a slash even if you specify it start" do
              expect(build('b[/ai]b'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/b(?!/)[/ai]b\z}, :allow)
            end
        ...
        describe 'Two consecutive asterisks ("**") in patterns matched against full pathname has special meaning:' do
          describe 'A leading "**" followed by a slash means match in all directories.' do
            ...
            it 'matches files or directories in all directories when also followed by a star within text' do
              expect(build('**/f*o'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/f[^/]*o\z}, :allow)
            end

            it 'matches files or directories in all directories when also followed by a star after text' do
              expect(build('**/fo*'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{/fo[^/]*\z}, :allow)
            end
          ...
          describe 'A trailing "/**" matches everything inside relative to the location of the .gitignore file.' do
            it 'matches files or directories inside the mentioned directory' do
              expect(build('abc/**'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{\A/abc/}, :allow)
            end
          ...
          describe 'A slash followed by two consecutive asterisks then a slash matches zero or more directories.' do
            it 'matches multiple intermediate dirs' do
              expect(build('a/**/b'))
                .to be_like PathList::Matchers::PathRegexp.new(%r{\A/a/(?:.*/)?b\z}, :allow)
            end
          ...
          describe 'but it would only find a match with a directory' do
            ...
            it 'handles this specific edge case i stumbled across' do
              expect(build('Ȋ/'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/ȋ/}, :allow)
                ])
            end
          end
        end
          ...
          describe 'then the pattern is relative to the directory level of the particular .gitignore file itself.' do
            ...
            it 'includes files relative to the git dir with a middle slash' do
              expect(build('doc/frotz'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::MatchIfDir.new(
                    PathList::Matchers::PathRegexp.new(%r{\A/(?:doc\z|\z)}, :allow)
                  ),
          ...
          describe 'Otherwise the pattern may also match at any level below the .gitignore level.' do
            ...
            it 'includes files relative to anywhere with only an end slash' do
              expect(build('frotz/'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/frotz/}, :allow)
                ])
            end
          ...
          describe 'Put a backslash ("\") in front of the first "!" for patterns that begin with a literal "!"' do
            ...
            it 'matches files starting with a literal ! if its preceded by a backslash' do
              expect(build('\!important!.txt'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/!important!\.txt/}, :allow)
                ])
            end
          end
        end
        ...
        describe 'Otherwise, Git treats the pattern as a shell glob' do
            ...
            describe 'single level' do
              ...
              it "matches any number of characters at the beginning if there's a star followed by a slash" do
                expect(build('*/our'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::MatchIfDir.new(
                      PathList::Matchers::PathRegexp.new(%r{\A/(?:[^/]*\z|\z)}, :allow)
                    ),
                    PathList::Matchers::PathRegexp.new(%r{\A/[^/]*/our/}, :allow)
                  ])
              end
              ...
              it "doesn't match a slash" do
                expect(build('f*our'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::AllowAnyDir,
                    PathList::Matchers::PathRegexp.new(%r{/f[^/]*our/}, :allow)
                  ])
              end
              ...
              it "matches any number of characters in the middle if there's a star" do
                expect(build('f*r'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::AllowAnyDir,
                    PathList::Matchers::PathRegexp.new(%r{/f[^/]*r/}, :allow)
                  ])
              end
              ...
              it "matches any number of characters at the end if there's a star" do
                expect(build('few*'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::AllowAnyDir,
                    PathList::Matchers::PathRegexp.new(%r{/few[^/]*/}, :allow)
                  ])
              end
            end
            ...
            describe 'multi level' do
              it 'matches a whole directory' do
                expect(build('a/*/c'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::MatchIfDir.new(
                      PathList::Matchers::PathRegexp.new(%r{\A/(?:a(?:/[^/]*\z|\z)|\z)}, :allow)
                    ),
                    PathList::Matchers::PathRegexp.new(%r{\A/a/[^/]*/c/}, :allow)
                  ])
              end
              ...
              it 'matches an exact partial match at start' do
                expect(build('a/b*/c'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::MatchIfDir.new(
                      PathList::Matchers::PathRegexp.new(%r{\A/(?:a(?:/b[^/]*\z|\z)|\z)}, :allow)
                    ),
              ...
              it 'matches multiple directories when beginning sequential /*/' do
                expect(build('*/*/c'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::MatchIfDir.new(
                      PathList::Matchers::PathRegexp.new(%r{\A/(?:[^/]*(?:/[^/]*\z|\z)|\z)}, :allow)
                    ),
                    PathList::Matchers::PathRegexp.new(%r{\A/[^/]*/[^/]*/c/}, :allow)
                  ])
              end
              ...
              it 'matches multiple directories when ending with /**/*' do
                expect(build('a/**/*'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::MatchIfDir.new(
                      PathList::Matchers::PathRegexp.new(%r{\A/(?:a(?:/|\z)|\z)}, :allow)
                    ),
                    PathList::Matchers::PathRegexp.new(%r{\A/a/.*/}, :allow)
                  ])
              end
          ...
          describe '"?" matches any one character except "/"' do
            ...
            it "doesn't match a slash" do
              expect(build('fa?our'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/fa[^/]our/}, :allow)
                ])
            end
            ...
            it "matches a single character at the end if there's a ?" do
              expect(build('fou?'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/fou[^/]/}, :allow)
                ])
            end
          end
          ...
          describe '"[]" matches one character in a selected range' do
            it 'matches a single character in a character class' do
              expect(build('a[ab]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[ab]/}, :allow)
                ])
            end
            ...
            it 'matches a single character in a character class range' do
              expect(build('a[a-c]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[a-c]/}, :allow)
                ])
            end
            ...
            it 'treats a backward character class range as only the first character of the range' do
              expect(build('a[d-a]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[d]/}, :allow)
                ])
            end
            ...
            it 'treats a escaped backward character class range as only the first character of the range' do
              expect(build('a[\\]-\\[]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[\]]/}, :allow)
                ])
            end
            ...
            it 'treats a backward character class range with other options as only the first character of the range' do
              expect(build('a[d-ba]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[da]/}, :allow)
                ])
            end
            ...
            it 'treats a backward char class range with other initial options as the first char of the range' do
              expect(build('a[ad-b]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[ad]/}, :allow)
                ])
            end
            ...
            it 'interprets a / before the dash in a character class range as any character from / to c' do
              expect(build('a[+/-c]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[\+/-c]/}, :allow)
                ])
            end
            ...
            context 'without raising warnings' do
              ...
              it 'interprets character dash dash dash as a character range of only with " to - with literal -' do
                ...
                expect(build('a["---]'))
                  .to be_like PathList::Matchers::Any::Two.new([
                    PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(
                      Regexp.new('/a(?!\/)["-\\-\\-]/'), :allow
                    )
                  ])
              end
            ...
            it '[^/a] matches everything except a' do
              expect(build('a[^/a]'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/a(?!/)[^/a]/}, :allow)
                ])
            end
            ...
            it "doesn't match a slash even if you specify it last" do
              expect(build('b[i/]b'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/b(?!/)[i/]b/}, :allow)
                ])
            end
            ...
            it "doesn't match a slash even if you specify it alone" do
              expect(build('b[/]b'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/b(?!/)[/]b/}, :allow)
                ])
            end
            ...
            it "doesn't match a slash even if you specify it start" do
              expect(build('b[/ai]b'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/b(?!/)[/ai]b/}, :allow)
                ])
            end
        ...
        describe 'A leading slash matches the beginning of the pathname.' do
          ...
          it 'matches only at the beginning of everything' do
            expect(build('/*.c'))
              .to be_like PathList::Matchers::Any::Two.new([
                PathList::Matchers::MatchIfDir.new(
                  PathList::Matchers::PathRegexp.new(%r{\A/(?:[^/]*\.c|\z)}, :allow)
                ), PathList::Matchers::PathRegexp.new(%r{\A/[^/]*\.c/}, :allow)
              ])
          end
        end
        ...
        describe 'Two consecutive asterisks ("**") in patterns matched against full pathname has special meaning:' do
          describe 'A leading "**" followed by a slash means match in all directories.' do
            ...
            it 'matches files or directories in all directories' do
              expect(build('**/foo'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir, PathList::Matchers::PathRegexp.new(%r{/foo/}, :allow)
                ])
            end
            ...
            it 'matches files or directories in all directories when also followed by a star within text' do
              expect(build('**/f*o'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/f[^/]*o/}, :allow)
                ])
            end
            ...
            it 'matches files or directories in all directories when also followed by a star after text' do
              expect(build('**/fo*'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::AllowAnyDir,
                  PathList::Matchers::PathRegexp.new(%r{/fo[^/]*/}, :allow)
                ])
            end
          ...
          describe 'A trailing "/**" matches everything inside relative to the location of the .gitignore file.' do
            it 'matches files or directories inside the mentioned directory' do
              expect(build('abc/**'))
                .to be_like PathList::Matchers::Any::Two.new([
                  PathList::Matchers::MatchIfDir.new(
                    PathList::Matchers::PathRegexp.new(%r{\A/(?:abc\z|\z)}, :allow)
                  ),
                  PathList::Matchers::PathRegexp.new(%r{\A/abc/.*/}, :allow)
                ])
            end
            ...
            it 'matches multiple intermediate dirs' do
              expect(build('a/**/b'))
                .to be_like PathList::Matchers::Any::Two.new([
                  ...
                  PathList::Matchers::PathRegexp.new(%r{\A/a/(?:.*/)?b/}, :allow)
                ])
            end
              ...
              context 'with two stars' do
                ...
                it 'matches any number of directories including none, when following a character, and anchors' do
                  expect(build('f**/our'))
                    .to be_like PathList::Matchers::Any::Two.new([
                      PathList::Matchers::MatchIfDir.new(
                        PathList::Matchers::PathRegexp.new(%r{\A/(?:f|\z)}, :allow)
                      ),
                      PathList::Matchers::PathRegexp.new(%r{\A/f(?:.*/)?our/}, :allow)
                    ])
                end
