...
RSpec.describe PathList::Matcher::LastMatch::Ignore do
  ...
  let(:matcher_ignore_c) do
    instance_double(PathList::Matcher, 'matcher_ignore_c', weight: 3, polarity: :ignore, squashable_with?: false)
  end
  let(:matcher_ignore_d) do
    instance_double(PathList::Matcher, 'matcher_ignore_d', weight: 4, polarity: :ignore, squashable_with?: false)
  end
  ...
  describe '.build' do
    it 'delegates build to the LastMatch class' do
      ...
      expect(described_class.build([
        ...
        described_class.new([
          matcher_ignore_c, matcher_ignore_b, matcher_ignore_a
        ])
      )
  ...
  describe '#inspect' do
    it do
      expect(subject).to have_inspect_value <<~INSPECT.chomp
        PathList::Matcher::LastMatch::Ignore.new([
