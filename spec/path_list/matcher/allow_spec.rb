...
RSpec.describe PathList::Matcher::Allow do
  ...
  describe '#inspect' do
    it { is_expected.to have_inspect_value 'PathList::Matcher::Allow' }
  end
  ...
  describe '#squashable_with?' do
    ...
    it { is_expected.not_to be_squashable_with(PathList::Matcher::Ignore) }
  end
